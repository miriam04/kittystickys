...
jQuery(window).load(function(){
   ...
   //Set Portfolio Items Height
    ...
    jQuery('section.newsletter .title p').appear();

    jQuery('body').on('appear', 'section.newsletter .title p', function() {

            var newsletter = [];

            jQuery('.service').each(function(){
                            newsletter.push(jQuery(this));
            });

            for(i=0; i <= newsletter.length; i++){
                            jQuery(newsletter[i]).delay(i * 400).animate({'opacity':1},400);
            }
    ...
    function setServiceHeight(){
        ...
        if(jQuery('section.newsletter .service').length > 0){
            
            jQuery('section.newsletter .service').css({'height':'auto'});
            
            jQuery('section.newsletter .service').each(function(){
            ...
            jQuery('section.newsletter .service').css({'height':serviceHeight + 20});
